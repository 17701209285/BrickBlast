...
public class PatchOperation : GameAsyncOperation
{
    ...
    public PatchOperation(string packageName, EPlayMode playMode, YooAssetGameRuntime runtime)
    {
        ...
        _machine.SetBlackboardValue("Runtime", runtime);
        _machine.SetBlackboardValue("RequestTimeout", runtime.Settings.RequestTimeoutSeconds);
        _machine.SetBlackboardValue("AppendTimeTicks", runtime.Settings.AppendTimeTicksToVersionRequest);
        _machine.SetBlackboardValue("DownloaderMaxConcurrency", runtime.Settings.DownloaderMaxConcurrency);
        _machine.SetBlackboardValue("FailedRetryCount", runtime.Settings.FailedRetryCount);
    }
