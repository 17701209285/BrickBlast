...
internal class FsmRequestPackageVersion : IStateNode
{
    ...
    void IStateNode.OnEnter()
    {
        ...
        runtime.RunHostedCoroutine(UpdatePackageVersion());
    }
    ...
    private IEnumerator UpdatePackageVersion()
    {
        ...
        bool appendTimeTicks = (bool)_machine.GetBlackboardValue("AppendTimeTicks");
        var package = YooAssets.GetPackage(packageName);
        var operation = package.RequestPackageVersionAsync(appendTimeTicks, timeout);
