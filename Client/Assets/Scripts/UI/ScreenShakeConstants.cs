public static class ScreenShakeConstants
{
    public const int MinimumDestroyedBricksForShake = 2;
    public const int DestroyedBricksForMaxShake = 8;
    public const float BaseShakeDuration = 0.22f;
